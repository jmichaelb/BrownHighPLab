function results=holten_LT_EOS(PT) % T in K, P in MPa
% function that returns the EOS for water extending into the supercooled
% regime as published in:
...
%
%  Usage: results=holten_LT_EOS(PT) where PT is either cell or scattered points
%  MPa and Kelvin units.  results is structure with EOS results in MKS units
%  code is modified from that in the paper’s supplemental information to match standard 
%  I/O conventions
% JMB 2017
